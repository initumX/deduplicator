"""
Unit tests for core/test_demasker.py
...
class TestBasicNormalization:
    ...
    def test_lowercase_conversion(self):
        ...
        assert demask_filename("PHOTO.JPG") == "photo.jpg"
        assert demask_filename("My_File.PDF") == "myfile.pdf"
        assert demask_filename("RePoRt.DoCx") == "report.docx"

    def test_noise_characters_removed(self):
        """Underscores, spaces, dots (in name), and hyphens should be removed."""
        assert demask_filename("my_file.jpg") == "myfile.jpg"
        assert demask_filename("my-file.jpg") == "myfile.jpg"
        assert demask_filename("my file.jpg") == "myfile.jpg"
        assert demask_filename("my.file.name.jpg") == "myfilename.jpg"
        assert demask_filename("my_file-name.jpg") == "myfilename.jpg"

    def test_extension_preserved(self):
        """File extension should be preserved (with dot)."""
        assert demask_filename("photo.jpg") == "photo.jpg"
        assert demask_filename("document.PDF") == "document.pdf"
        assert demask_filename("archive.tar.gz") == "archivetar.gz"  # Only last ext split

    def test_empty_input(self):
        """Empty string should return empty string."""
        assert demask_filename("") == ""
...
class TestBracketRemoval:
    ...
    def test_numeric_brackets_removed(self):
        ...
        assert demask_filename("Photo (1).jpg") == "photo.jpg"
        assert demask_filename("Photo (2).jpg") == "photo.jpg"
        assert demask_filename("Photo (123).jpg") == "photo.jpg"

    def test_text_brackets_removed(self):
        """Text markers in brackets should be removed."""
        assert demask_filename("Photo (copy).jpg") == "photo.jpg"
        assert demask_filename("Photo (Copy).jpg") == "photo.jpg"
        assert demask_filename("Photo (final).jpg") == "photo.jpg"
        assert demask_filename("Photo (Final Version).jpg") == "photo.jpg"
    ...
    def test_multiple_brackets_removed(self):
        ...
        assert demask_filename("Photo (1) (2).jpg") == "photo.jpg"
        assert demask_filename("Photo (copy) (final).jpg") == "photo.jpg"
        assert demask_filename("Photo (1) (copy).jpg") == "photo.jpg"
...
class TestCopyMarkerRemoval:
    ...
    def test_copy_word_removed(self):
        ...
        assert demask_filename("Photo_copy.jpg") == "photo.jpg"
        assert demask_filename("Photo_Copy.jpg") == "photo.jpg"
        assert demask_filename("PhotoCOPY.jpg") == "photo.jpg"
        assert demask_filename("Photo-Copy.jpg") == "photo.jpg"
        assert demask_filename("Photo copy.jpg") == "photo.jpg"

    def test_copy_with_number_removed(self):
        """'copy' marker with number should be removed."""
        assert demask_filename("Photo_copy2.jpg") == "photo.jpg"
        assert demask_filename("Photo_Copy12.jpg") == "photo.jpg"
        assert demask_filename("PhotoCopy3.jpg") == "photo.jpg"
        assert demask_filename("Photo-copy_5.jpg") == "photo.jpg"

    def test_other_keywords_removed(self):
        """Other keywords (new, final, old, backup) should be removed."""
        assert demask_filename("Photo_new.jpg") == "photo.jpg"
        assert demask_filename("Photo_final.jpg") == "photo.jpg"
        assert demask_filename("Photo_old.jpg") == "photo.jpg"
        assert demask_filename("Photo_backup.jpg") == "photo.jpg"
        assert demask_filename("Photo_new2.jpg") == "photo.jpg"
        assert demask_filename("Photo_final3.jpg") == "photo.jpg"

    def test_keyword_only_at_end(self):
        """Keywords should only be removed if at end of filename."""
        assert demask_filename("copy_photo.jpg") == "copyphoto.jpg"  # Not at end
        assert demask_filename("new_report.pdf") == "newreport.pdf"  # Not at end
        assert demask_filename("final_draft.pdf") == "finaldraft.pdf"  # Not at end
    ...
    def test_keyword_with_separator_variations(self):
        ...
        assert demask_filename("Photo-copy.jpg") == "photo.jpg"
        assert demask_filename("Photo copy.jpg") == "photo.jpg"
        assert demask_filename("Photo_copy_2.jpg") == "photo.jpg"
        assert demask_filename("Photo-copy-2.jpg") == "photo.jpg"
...
class TestCameraFileHandling:
    ...
    def test_camera_files_different_numbers_not_grouped(self):
        ...
        key1 = demask_filename("DSC_0001.jpg")
        key2 = demask_filename("DSC_0002.jpg")
        key3 = demask_filename("DSC_0003.jpg")
    ...
    def test_camera_files_with_copy_markers_grouped(self):
        ...
        original = demask_filename("DSC_3088.jpg")
        copy1 = demask_filename("DSC_3088copy.jpg")
        copy2 = demask_filename("DSC_3088copy2.jpg")
        copy3 = demask_filename("DSC_3088 (1).jpg")
    ...
    def test_camera_files_mixed_separators(self):
        ...
        base = demask_filename("IMG_1001.jpg")
        variants = [
            demask_filename("IMG_1001_copy.jpg"),
            demask_filename("IMG_1001-copy.jpg"),
            demask_filename("IMG_1001 copy.jpg"),
            demask_filename("IMG_1001_copy2.jpg"),
            demask_filename("IMG_1001 (1).jpg"),
        ]
...
class TestNonCameraTrailingNumbers:
    ...
    def test_trailing_numbers_removed_regular_files(self):
        ...
        assert demask_filename("Report_1.pdf") == "report.pdf"
        assert demask_filename("Report_2.pdf") == "report.pdf"
        assert demask_filename("Report_123.pdf") == "report.pdf"
        assert demask_filename("Report-1.pdf") == "report.pdf"
        assert demask_filename("Report-12.pdf") == "report.pdf"
        assert demask_filename("Report_2014.pdf") == "report2014.pdf"

    def test_trailing_numbers_without_separator_preserved(self):
        """Numbers without separator should NOT be removed (part of name)."""
        assert demask_filename("Report1.pdf") == "report1.pdf"
        assert demask_filename("file123.txt") == "file123.txt"
        assert demask_filename("version2.docx") == "version2.docx"

    def test_numbers_in_middle_preserved(self):
        """Numbers in middle of filename should be preserved."""
        assert demask_filename("Report_2024.pdf") == "report2024.pdf"
        assert demask_filename("Invoice_12345.pdf") == "invoice12345.pdf"
        assert demask_filename("Backup_2024_01_01.tar.gz") == "backup20240101tar.gz"
    ...
    def test_camera_vs_regular_distinction(self):
        ...
        assert demask_filename("DSC_2726.jpg") == "dsc2726.jpg"
        assert demask_filename("DSC_2727.jpg") == "dsc2727.jpg"  # Different!

        # Regular: trailing number removed
        assert demask_filename("Photo_2726.jpg") == "photo2726.jpg"
        assert demask_filename("Photo_2727.jpg") == "photo2727.jpg"  # Same!
...
class TestEdgeCases:
    ...
    def test_only_special_chars_name(self):
        ...
        assert demask_filename("___(123).jpg") == ".jpg"
        assert demask_filename(" - - .pdf") == ".pdf"

    def test_unicode_and_special_chars(self):
        """Unicode and special chars should be handled gracefully."""
        # Unicode preserved (only specific chars removed)
        assert demask_filename("файл_001.jpg") == "файл.jpg"
        assert demask_filename("Ñoño_01.jpg") == "ñoño.jpg"

        # Special chars removed
        assert demask_filename("file@name#.jpg") == "file@name#.jpg"  # @# not in noise list
    ...
    def test_double_extension_handling(self):
        ...
        assert demask_filename("archive.tar.gz") == "archivetar.gz"  # name="archive.tar"
        assert demask_filename("backup_copy2.tar.gz") == "backupcopy2tar.gz"  # copy2 is not trailing -> preserved
        assert demask_filename("file (1).tar.gz") == "filetar.gz"  # (1) removed

    def test_no_extension(self):
        """Files without extension should still be normalized."""
        assert demask_filename("README") == "readme"
        assert demask_filename("Makefile_1") == "makefile"  # trailing _1 removed
        assert demask_filename("DSC_0001") == "dsc0001"  # camera: number preserved

    def test_mixed_case_keywords(self):
        """Copy keywords should be case-insensitive."""
        assert demask_filename("Photo_COPY.jpg") == "photo.jpg"
        assert demask_filename("Photo_Copy2.jpg") == "photo.jpg"
        assert demask_filename("Photo_NEW.pdf") == "photo.pdf"
        assert demask_filename("Photo_Final3.pdf") == "photo.pdf"
...
class TestIntegrationScenarios:
    ...
    def test_real_world_duplicates_grouped(self):
        ...
        for scenario in scenarios:
            keys = [demask_filename(f) for f in scenario]
    ...
    def test_real_world_non_duplicates_separated(self):
        ...
        for file1, file2 in non_duplicates:
            key1 = demask_filename(file1)
            key2 = demask_filename(file2)
...
class TestCacheBehavior:
    ...
    def test_cache_returns_same_object(self):
        ...
        result1 = demask_filename("Test_File.jpg")
        result2 = demask_filename("Test_File.jpg")

        # Cached strings may be interned; at minimum, values should be equal
        assert result1 == result2

        # Check cache info if available
        if hasattr(demask_filename, 'cache_info'):
            info = demask_filename.cache_info()
            assert info.misses >= 1  # At least one miss for first call
            # Second call should be a hit (if same input)
            demask_filename("Test_File.jpg")
            info2 = demask_filename.cache_info()
